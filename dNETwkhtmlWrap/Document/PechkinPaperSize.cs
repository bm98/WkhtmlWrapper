...
{
  /// <summary>
  /// Papper Sizes and their dimensions
  /// </summary>
  [Serializable]
  public class PechkinPaperSize
  {
    ...
    /// <summary>
    /// cTor: create using width and height
    /// </summary>
    /// <param name="width">Width + selected Unit</param>
    /// <param name="height">Height + selected Unit</param>
    ...
    /// <summary>
    /// Width string includes Unit
    /// </summary>
    public string Height { get; set; }

    /// <summary>
    /// Height string includes Unit
    /// </summary>
    ...
    /// Indexer operator
    /// </summary>
    /// <param name="paperKind">A PaperKind</param>
